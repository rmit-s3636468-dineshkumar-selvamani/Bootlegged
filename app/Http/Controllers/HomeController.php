...
$products=DB::table('store_listings')->where('sListing_type','LIKE','%'.$request->search."%")->get();
...
'<td>'.$product->sListing_type.'</td>'.
 
'<td>'.$product->sListing_qty.'</td>'.
 
'<td>'.$product->sListing_active.'</td>'.
 
'<td>'.$product->sListing_condition.'</td>'.
