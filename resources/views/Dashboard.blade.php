...
.twitter-typeahead {
    ...
    <div class="compare-basket">
        <button class="action action--button action--compare"><i class="fa fa-check"></i><span class="action__text">Compare</span>
        </button>
    </div>
    ...
    <div class="view" style="margin-left: 14%;">
        ...
        <div class="container">
            ...
            <div class="starter-template" style="align-text:center">
                ...
                <input type="text" class="typeahead form-control" id="search" placeholder="Search by product Name"
                       autocomplete="on">
            </div>
                ...
                @foreach($products as $item)
                    ...
                    <div class="product">
                        <div class="product__info" data-toggle="modal"
                             data-target="#prod_details" data-prodname="{{$item->product_itemName}}"
    ...
    <section class="compare">
        <button class="action action--close"><i class="fa fa-remove"></i><span
                    class="action__text action__text--invisible">Close comparison overlay</span></button>
    </section>
