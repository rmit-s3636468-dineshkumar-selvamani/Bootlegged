                ...
                <div class="row">
                    ...
                    <div class="opportunity-table">
                        <div class="table-responsive mx-3">
                            <table class="table table-striped table-sm" style="border-collapse: separate; border-spacing: 40px 0">
                                {{-- Table Header --}}
                                <thead>
                                <tr>
                                        ...
                                        <tr>
                                            @foreach ($currentColumn as $c)
                                                @if($product->product_id == $currentPID)
                                                    ...
                                                    @elseif($c=="View")
                                                        <td>
                                                            <button type="button" id="modal" class="openListing btn btn-info" data-toggle="modal" data-target="#prod_details" data-prodname="{{$itemName}}" data-type="{{$listing->Listing_type}}" data-total_qty="{{ $listing->Listing_qty }} "
                                                                    data-unit="{{ $listing->Listing_unitPrice }}" data-total="{{ $listing->Listing_totalPrice }}"
                                                                    data-expiry="{{ $listing->Listing_expiry }}" data-vintage="{{ $listing->Listing_vintage }}"
                                                                    data-condition="{{ $listing->Listing_condition }}" style="background-color:#333">View</button>
                                                        </td>
                                                    @endif
                                                @endif
                                            @endforeach
